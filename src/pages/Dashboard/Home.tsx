          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="group rounded-lg border border-stroke bg-white p-6 shadow-default transition-all duration-300 hover:shadow-lg hover:-translate-y-1 dark:border-strokedark dark:bg-boxdark">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm font-medium text-body dark:text-bodydark">Active Courses</p>
                </div>
              </div>
            ...
            <div className="group rounded-lg border border-stroke bg-white p-6 shadow-default transition-all duration-300 hover:shadow-lg hover:-translate-y-1 dark:border-strokedark dark:bg-boxdark">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <h3 className="text-3xl font-bold text-black dark:text-white">12</h3>
                  <p className="text-sm font-medium text-body dark:text-bodydark">Pending Assignments</p>
                </div>
              </div>
              <div className="mt-4 flex items-center">
            ...
            <div className="group rounded-lg border border-stroke bg-white p-6 shadow-default transition-all duration-300 hover:shadow-lg hover:-translate-y-1 dark:border-strokedark dark:bg-boxdark">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <h3 className="text-3xl font-bold text-black dark:text-white">8.5</h3>
                  <p className="text-sm font-medium text-body dark:text-bodydark">Overall GPA</p>
                </div>
              </div>
              <div className="mt-4 flex items-center">
                <span className="flex items-center text-sm text-meta-3">
